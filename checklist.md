...
_Hurlothrumbo: or: the super-natural_ by Johnson, Samuel

## Project Info
* Project Name: hurlo
* Title: Hurlothrumbo: or: the super-natural
* Author: Johnson, Samuel
* [Project Page](https://www.pgdp.net/c/project.php?id=projectID66bce97e1ca75)
* [Project Comments](https://www.pgdp.net/c/project.php?id=projectID66bce97e1ca75#project-comments)
* [Project Forum](https://www.pgdp.net/phpBB3/viewtopic.php?t=82260)
* [Github Repository](https://github.com/matteverett/pgdp_hurlo)
...
### Setup Guiguts
* [x] Open `hurlo-src.txt` in Guiguts
...
* [x] Use `Tools → Word Distance Check...`
  * Unable to run due to extreme number of false positives (3000+)
* [x] Correct entries as appropriate
